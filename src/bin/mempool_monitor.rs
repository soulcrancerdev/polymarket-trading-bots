...
use polymarket_copier::trading::risk_guard::{RiskGuard, RiskGuardConfig, SafetyDecision, TradeSide};
use polymarket_copier::models::{OrderInfo, SizeType, ResubmitRequest};
...
async fn main() -> Result<()> {
    ...
    println!("{} ╚═════╝ ╚═════╝ ╚═╝     ╚═╝╚══════╝╚═╝  ╚═╝                                           {}",
        BRIGHT_MAGENTA, RESET);
    println!();
    println!("{}              Mempool Mode | Copy the best, automate success{}", BRIGHT_CYAN, RESET);
    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
...
fn fetch_book_depth_blocking(
    ...
    Ok(polymarket_copier::trading::risk_guard::calc_liquidity_depth(side, &levels, threshold))
}
...
async fn handle_event(evt: ParsedEvent, order_engine: &OrderEngine, http_client: &reqwest::Client) {
    ...
    let atp_display = if market_cache::get_atp_token_buffer(&evt.order.clob_token_id) > 0.0 {
    ...
    let ligue1_display = if market_cache::get_ligue1_token_buffer(&evt.order.clob_token_id) > 0.0 {
...
fn submit_resubmit_order_sync(
    ...
    use polymarket_copier::config::gtd_expiry_seconds;
