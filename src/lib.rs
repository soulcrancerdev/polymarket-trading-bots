...
impl RustClobClient {
    ...
    pub fn create_order(&mut self, args: OrderArgs) -> Result<SignedOrder> {
        ...
        let neg_risk = if let Some(n) = crate::markets::market_cache::is_neg_risk(&args.token_id) {
            n
        }
        ...
        // Last resort: API call on complete cache miss
            ...
            crate::markets::market_cache::global_caches().set_neg_risk(args.token_id.clone(), nr);
